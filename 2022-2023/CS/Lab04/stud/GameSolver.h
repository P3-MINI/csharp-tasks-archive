...
{
public:
	GameSolver(uint _column_count, uint _row_count, const std::vector<uint>& _column_sum, const std::vector<uint>& _row_sum);
...
private:
	...
	//Można dodać potrzebne składowe oraz metody
};