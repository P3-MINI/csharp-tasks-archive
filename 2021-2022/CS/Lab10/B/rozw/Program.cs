    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Stage 4 - 1.5 points
            {
                ...
                //Action to fill
                persons.PerformAction((x,i) =>
                {
                    if (i % 3 == 0)
                    {
                        x.Age += 100;
                        Console.WriteLine($"{i}: Age changed!");
                    }
                    else
                    {
                        Console.WriteLine($"{i}: No changes made");
                    }
                });
                Console.WriteLine("\n\n");
                ...
                var transformedDoubles = persons.Accumulate((person, sum) => sum + person.Age,0);
