...
namespace A
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<IFormula<double>> formulas1 = new List<IFormula<double>>() { new QuadraticFormula(1, 2, 3), new QuadraticFormula(3, 5, 7), new QuadraticFormula(3, 2, 1) };
            List<IFormula<uint>> formulas2 = new List<IFormula<uint>>() { new ArithmeticSequenceSumFormula(1, 2), new ArithmeticSequenceSumFormula(3, 5), new ArithmeticSequenceSumFormula(3, 2) };
            ...
            Console.WriteLine("");
            foreach (QuadraticFormula formula in formulas1)
            {
            ...
            Console.WriteLine("");
            FibonnaciGenerator<double> fbg = new FibonnaciGenerator<double>(new QuadraticFormula(2, 3, 4));
