...
public class Duck
{
    ...
    [JsonIgnore] public Billboard NameBillboard { get; private set; }
    ...
    [JsonDerivedType(typeof(RandomlyMoving), typeDiscriminator: "random")]
    [JsonDerivedType(typeof(PlayerControlled), typeDiscriminator: "player")]
