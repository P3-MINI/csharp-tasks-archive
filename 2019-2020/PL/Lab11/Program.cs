...
namespace pl_lab11
{
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            {
                SepalLength = Convert.ToDouble(data["sepal.length"].Replace('.', ',')),
                SepalWidth = Convert.ToDouble(data["sepal.width"].Replace('.', ',')),
                PetalLength = Convert.ToDouble(data["petal.length"].Replace('.', ',')),
                PetalWidth = Convert.ToDouble(data["petal.width"].Replace('.', ',')),
