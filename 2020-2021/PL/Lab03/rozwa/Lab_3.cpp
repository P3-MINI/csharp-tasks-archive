    ...
    std::cout << " --------------------- ETAP_1 (2.0 Pts) ---------------------" << std::endl;
    {
        ...
        */

        {
            ...
            {
                auto permissions = std::filesystem::status(currentEntry.path()).permissions();

                if ((std::filesystem::perms::others_write & permissions) != std::filesystem::perms::none)
                    std::cout << "Has Others Write Permission! " << currentEntry.path().filename() << std::endl;
            }
    ...
    std::cout << " --------------------- ETAP_3 (1.0 Pts) ---------------------" << std::endl;
    {
        ...
        */

        {
            ...
            std::for_each(assets.begin(), assets.end(), [](const std::unique_ptr<Asset>& currentAsset)
            {
                std::cout << currentAsset->GetName() << std::endl;
            });
        }
    }
